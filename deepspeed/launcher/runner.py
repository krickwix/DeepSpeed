...
EXPORT_ENVS = [
    ...
    'PT_HPU_ENABLE_WEIGHT_CPU_PERMUTE', 'PT_HPU_ENABLE_DETERMINISTIC_MODE'
]
...
def main(args=None):
    ...
    if args.use_hpu:
        ...
        # todo  SW-145682: remove the bewlow WA, and set hpu.setDeterminstic(True) from accelerator
        update_wa_env_var("PT_HPU_ENABLE_DETERMINISTIC_MODE", "1")
